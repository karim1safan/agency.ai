...
function Hero() {
  return (
    ...
    <div id='home' className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white">
      ...
      viewport={{once: true}}
      className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-23.75 max-w-5xl capitalize">
      ...
      viewport={{once: true}}
      className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3 transform-none" style={{opacity: "1"}}>
      ...
      viewport={{once: true}}
      className='relative transform-none' style={{opacity: "1"}}>
